...
=======
-- Updated with new audit tables from the provided image
...
>>>>>>> 64457b1e48d65d29ec1a4a42779a1263229a9664
-- -----------------------------------------------------
...
=======
  ...
  PRIMARY KEY (`ProfileID`, `FilmID`),
  CONSTRAINT `FK_WatchingFilm_Profile`
    FOREIGN KEY (`ProfileID`)
    REFERENCES `mydb`.`Profile` (`ProfileID`),
  CONSTRAINT `FK_WatchingFilm_Film`
    FOREIGN KEY (`FilmID`)
    REFERENCES `mydb`.`Film` (`FilmID`)
);
>>>>>>> 64457b1e48d65d29ec1a4a42779a1263229a9664
